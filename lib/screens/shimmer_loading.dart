...
// ═══════════════════════════════════════════════════
/// Widget reutilizable que aplica un efecto shimmer a su child.
/// Útil para mostrar skeletons de carga en cualquier pantalla.
///
/// Uso:
/// ```dart
/// ShimmerLoading(
      ...
      builder: (context, child) {
        return ShaderMask(
          shaderCallback: (bounds) {
            final dx = _animation.value * bounds.width;
...
/// Transformación de gradiente para el efecto shimmer.
